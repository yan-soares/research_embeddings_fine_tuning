...
class STSEval(object):
    def loadFile(self, fpath):
        ...
        for dataset in self.datasets:
            ...
            sent1 = np.array([s.split() + [''] * (max_length - len(s.split())) for s in sent1], dtype=object)[not_empty_idx]
            sent2 = np.array([s.split() + [''] * (max_length - len(s.split())) for s in sent2], dtype=object)[not_empty_idx]
